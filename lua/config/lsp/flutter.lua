    ...
    setup = function(lsp)
        ...
        flutter.setup({
            ...
            debugger = {
                ...
                -- if empty dap will not sotp on any exceptions, otherwise it will stop on those specified
                        ...
                        dap.configurations.dart = {
                            {
                                ...
                                cmd = "${workspaceFolder}",
                                -- This gets forwarded to the Flutter CLI tool, substitude `linux` for whatever device you wish to launch
                                toolArgs = { "-d", "macos" }
                            }
                        }
                    end
